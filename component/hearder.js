...
<header class="header" id="header">
  <nav class="nav container">
    <div class="nav__logo">
      <div class="nav__logo__img" style="width: 60px">
        <svg
          id="Layer_1"
          data-name="Layer 1"
      ...
      <a href="../index.html" class="nav__logo__text">Travel.com</a>
    </div>
    <!-- Nav menu -->
    <div class="nav__menu" id="nav-menu">
      <ul class="nav__list">
        ...
        <li class="nav__item">
          <a href="../index.html#discover" class="nav__link">Discover</a>
        </li>
        <li class="nav__item">
          <a href="../page/contact-us.html" class="nav__link">Contact Us</a>
        </li>
      </ul>
      <!-- dark mode  -->
      <div class="nav__dark">
